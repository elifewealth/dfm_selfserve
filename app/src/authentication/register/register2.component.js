(function () {
    ...
    angular.module('selfService')
        .controller('Register2Ctrl', ['$scope', '$state', '$mdToast', 'AuthService', '$location',  Register2Ctrl]);
     ...
     */
    function Register2Ctrl($scope, $state, $mdToast, AuthService, $location) {
        var vm = this;
        ...
        $scope.submit = function() {
            AuthService.register2(vm.form).then(function () {
                $mdToast.show(
                    $mdToast.simple()
